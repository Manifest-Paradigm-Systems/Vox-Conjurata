...
PALETTE_DEFINITIONS: dict[str, str] = {
    ...
    "monster_beast":   "[extreme guttural growl, deep, resonant, beastly, low rumble, predatory] The scent of fear is thick in the air. I can hear the beating of your heart from across the clearing. You are far from your home, little one, and the forest does not take kindly to intruders who walk so loudly.",
    "monster_undead":  "[extreme hollow rasp, death rattle, whisper, heavy echo, ghostly, ethereal] Death is not the end, but merely a change in perspective. I have walked the halls of silence for centuries, waiting for the warmth of a soul to flicker near the cold embers of my existence. Join me in the quiet.",
    "monster_dragon":  "[extreme deep rumble, ancient, commanding, heavy echoing, immense, monstrous, distorted] You stand before a power that predates your entire civilization. My scales are like shields and my breath is a furnace that has consumed kings and their treasures. Tell me, why should I not simply turn you to ash where you stand?",
    "monster_demon":   "[Arabic accent, extreme demonic distortion, multi-layered voice, infernal growl, low, ancient] The shadows of the abyss are infinite, and I am their chosen voice. I have tasted the bitterness of a thousand betrayals and the sweetness of a soul consumed. Your petty desires are nothing to me, mortal.",
    "monster_goblin":  "[extreme high pitched, nasally, screechy, chittering, rapid, manic] Look what we found! A shiny toy for the pot! Don't let it run away, no, no! We take it back to the chief, and maybe he lets us keep the boots! Yes, yes, the boots are the best part, aren't they?",
}
