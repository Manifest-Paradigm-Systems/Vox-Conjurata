...
TTS_MUSIC_URL = os.getenv("TTS_MUSIC_URL", "http://vox-audio-generation-music:8000")
    ...
    async with httpx.AsyncClient(timeout=120.0) as client:
        try:
            ...
            resp = await safe_post(f"{IMAGE_GEN_URL}/generate", {
                "prompt": action_prompt, "width": 1920, "height": 1080, "steps": 4, "cfg_scale": 1.0, "sample_method": "euler"
            })
            if resp.status_code == 200:
            ...
            resp_hit = await safe_post(f"{IMAGE_GEN_URL}/generate", {
                "prompt": hit_prompt, "width": 1920, "height": 1080, "steps": 4, "cfg_scale": 1.0, "sample_method": "euler"
            })
            ...
            resp_miss = await safe_post(f"{IMAGE_GEN_URL}/generate", {
                "prompt": miss_prompt, "width": 1920, "height": 1080, "steps": 4, "cfg_scale": 1.0, "sample_method": "euler"
            })
